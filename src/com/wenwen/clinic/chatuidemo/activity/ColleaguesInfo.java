        ...
        HttpClientRequest.post(Urls.GETUSERDETAILS, params, 3000,
                new AsyncHttpResponseHandler() {
                    ...
                    public void onSuccess(int arg0, Header[] arg1, byte[] arg2) {
                        // TODO Auto-generated method stub
                        /*
                         * ﻿{"ret":"1","account_id":"32","account_username":
                         * "13646871111",
                         ...
                         * "account_info":"\u4e0d\u5b55\u4e0d\u80b2",
                         * "account_job":"\u4e3b\u6cbb\u533b\u751f",
                         * "account_set_order":"123", "gg_content":"",
                         * "gg_addtime":""}
                         */
                        try {
                            ...
                            case 1:
                                ...
                                name.setText(result.getString("account_name")
                                        + "  "
                                        + result.getString("account_job"));
                                hospital.setText(result
                                        .getString("account_hospital"));
                                information.setText(result
                                        .getString("account_info"));
                                break;
                            default:
                                break;
