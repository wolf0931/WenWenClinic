    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        try {
            if (conversation.getLastMessage().getStringAttribute("type").equals("2")) {
                holder.name.setText(conversation.getLastMessage().getStringAttribute("toaccountname"));
            }else {
                holder.name.setText(conversation.getLastMessage().getStringAttribute("accountname"));
            }
